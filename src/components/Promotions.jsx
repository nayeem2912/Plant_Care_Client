...
const Promotions = () => {
  ...
  return (
    <section className="py-10 px-4 max-w-7xl mx-auto" data-aos="fade-up">
      ...
      <p className="text-center  mb-6">Don’t miss these limited-time plant offers and discounts!</p>
        ...
        {offers.map((item, index) => (
          <div key={index} className="card bg-gray-50 border-base-300 text-gray-800 shadow-md" data-aos="zoom-in" data-aos-delay={`${index * 100}`}>
            ...
            <div className="card-body">
              ...
              <Link to='/addPlant'>
              <button className="btn w-full hover:text-white hover:bg-[#0EA106] btn-outline btn-sm mt-2">Claim Offer</button>
              </Link>
            </div>
          </div>
        ))}
